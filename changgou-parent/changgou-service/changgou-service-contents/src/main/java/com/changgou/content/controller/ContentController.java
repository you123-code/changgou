...
public class ContentController {
    ...
    @ApiOperation(value = "根据categoryID查询广告信息")
    @ApiImplicitParams({
            @ApiImplicitParam( name = "id", value = "categoryId"),
    })
    @PostMapping(value = "/list/category")
    public Result<List<Content>> findByCategoryId(Long id){
        //根据分类id查询广告集合
        List<Content> contentList  = contentService.findByCategory(id);
        return new Result<List<Content>>(true,StatusCode.OK,"根据categoryID查询广告信息成功",contentList);
    }
