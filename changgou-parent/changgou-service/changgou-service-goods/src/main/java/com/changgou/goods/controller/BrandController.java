...
public class BrandController {
     ...
     * 根据categoryId查询品牌信息
     */
    @ApiOperation(value = "根据分类查询所有品牌")
    @ApiImplicitParam(name = "categoryId",paramType = "path",value = "分类id")
    ...
    public Result<List<Brand>> findByCategoryId(@PathVariable(value = "categoryId") Integer categoryId){
        ...
        return new Result<List<Brand>>(true,StatusCode.OK,"根据分类id查询品牌信息",brands);
    }
